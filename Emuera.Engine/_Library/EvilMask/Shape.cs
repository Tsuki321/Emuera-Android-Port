...
// Note: System.Drawing.Color/Rectangle are cross-platform via System.Drawing.Primitives.
// All GDI+ rendering (Graphics, GraphicsPath, SmoothingMode) removed — rendering handled by platform host.
...
internal sealed class Shape
{
	...
	/// <summary>Stub — border drawing is now performed by the platform rendering host.</summary>
	internal sealed class BoxBorder
	{
		public static void DrawBorder(Rectangle rect, int[] border, int[] radius, Color[] colors, Color bgColor)
		{
			// Platform host renders div borders; this stub exists for the engine data model only.
		}
	}
}
