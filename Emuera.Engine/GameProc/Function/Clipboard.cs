...
// System.Windows.Forms removed — clipboard is now platform-provided via IPlatformClipboard stub.
...
internal class ClipboardProcessor
{
	...
	private delegate void SetClipboardDelegate(string text, bool copy, int times, int delay);
	...
	private void SendToCB(bool force)
	{
		...
		// Platform clipboard: stored as latest string; actual OS clipboard copy handled by the platform host.
		try
		{
			OldText = newText;
