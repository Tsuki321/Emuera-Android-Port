...
{
	public StringStyle(Color color, EngineFontStyle fontStyle, string fontname)
	{
		this.Color = color;
	...
	/// </summary>
	public StringStyle(Color color, bool colorChanged, Color buttonColor, EngineFontStyle fontStyle, string fontname)
	{
		this.Color = color;
	...
	public EngineFontStyle FontStyle;
