...
partial class Rikaichan
{
	...
	private void Init()
	{
		...
		else
		{
			...
			var dialog = new RikaiDialogBase(Config.RikaiFilename, edict, ReceiveIndex);
	...
	// Phase 3: re-implement OnPaint using SkiaSharp
	public void OnPaint(object canvasObj, StringMeasure stringMeasure, int screenWidth)
	{
#if false
		if (!enabled) return;
